...
|----------|-------------|----------|-----------------|-----------|-----------|---------------|
| `retention_duration` | At what relative time in the future, compared to its creation time, the backup should be deleted, e.g. keep backups for 7 days. A duration in seconds with up to nine fractional digits, ending with 's'. Example: '3.5s'. You can set this to a value up to 366 days. | true | true | Setting a retention duration of at least 7 days (604800s) ensures backups remain available for recovery within the required window. Too short a retention period risks data loss if recovery is needed beyond the retention window. | 2592000s | 86400s |
